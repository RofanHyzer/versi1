...
await loading()
let footzoo1 = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
...
break 
case 'donasi':
let footzoo2 = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `┌──═━𝘿𝙞𝙩𝙯 𝘿𝙚𝙢𝙤𝙣━═──┐
Hay Kak ${pushname} 👋
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
let footzoo3 = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `┌──═━𝘿𝙞𝙩𝙯 𝘿𝙚𝙢𝙤𝙣━═──┐
Hay Kak ${pushname} 👋
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
let footzoo4 = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `┌──═━𝘿𝙞𝙩𝙯 𝘿𝙚𝙢𝙤𝙣━═──┐
Hay Kak ${pushname} 👋
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
let footzoo5 = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `┌──═━𝘿𝙞𝙩𝙯 𝘿𝙚𝙢𝙤𝙣━═──┐
Hay Kak ${pushname} 👋
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
let footzooislam = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `┌──═━𝘿𝙞𝙩𝙯 𝘿𝙚𝙢𝙤𝙣━═──┐
Hay Kak ${pushname} 👋
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
let footgkkfke = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `┌──═━𝘿𝙞𝙩𝙯 𝘿𝙚𝙢𝙤𝙣━═──┐
Hay Kak ${pushname} 👋
